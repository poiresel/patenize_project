...
render() {
    return (
      <div>
        ...
        <h2>Welcome Company B!</h2>
        <h3>Your patent is not unique. It's been designated as an improvement patent.</h3>
        <h4>Related Patents</h4> 
        <ul>
        <li>Company A : Patent A <button>Enter agreement</button></li>
        </ul>
